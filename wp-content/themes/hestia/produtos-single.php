<?php
	/*
	Template Name:Página de Produto
	Template Post Type: page, cartoes, investimentos, seguros
	*/
get_header(); ?>

<!-- INÍCIO BIG DISPLAY -->
<?php 
$display = get_field('big_display');
 ?>
<div id="primary" class="page-header header-filter header-small" data-parallax="active" style="background-image: url('<?php echo $display['url']; ?>');">
	<div class="container">
		<div class="row">
